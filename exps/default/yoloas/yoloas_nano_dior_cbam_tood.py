...
class Exp(MyExp):
    ...
    def get_model(self, sublinear=False):
        ...
        if "model" not in self.__dict__:
            ...
            from yolori.models.neck import PAFPN_ASFF, PANFPN_AS_SCA, CBAM_PANFPN_AS_SCA, CBAM_PAFPN
            ...
            neck = CBAM_PAFPN(self.depth, self.width, depthwise=True)
            head = TOODHead(self.num_classes, self.width, in_channels=in_channels, act=self.act, depthwise=True)
