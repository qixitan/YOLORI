...
from yolori.data.data_augment import ValTransform
from yolori.data.datasets.dior_classes import DIOR_CLASSES
from yolori.exp import get_exp
from yolori.utils import fuse_model, get_model_info, postprocess, vis
...
def main(exp, args):
    ...
    predictor = Predictor(
        model, exp, DIOR_CLASSES, trt_file, decoder,
