...
from yolori.data import DataPrefetcher
...
class Trainer:
    ...
    def train_one_iter(self):
        ...
        self.total_loss.append(outputs["total_loss"])
        self.iou_loss.append((outputs["iou_loss"]))
    ...
    # 记录每个epoch的损失
    def save_loss(self):
        total_loss = sum(self.total_loss)/len(self.total_loss)
        iou_loss = sum(self.iou_loss)/len(self.iou_loss)
