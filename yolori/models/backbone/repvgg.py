...
from yolori.models.network_blocks import get_activation
    ...
    def __init__(self,
        ...
        if deploy:
            self.rbr_reparam = nn.Conv2d(
                in_channels=in_channels, out_channels=out_channels, kernel_size=ksize, stride=stride, padding=padding,
            ...
            self.rbr_1x1 = conv_bn(
                in_channels=in_channels, out_channels=out_channels, kernel_size=1, stride=stride, padding=padding_11,
                groups=groups
            )
...
class RepVGGYOLOX(nn.Module):
    ...
    def __init__(
        ...
        self.stem = RepVGGBlock(
            ...
            ksize=3,
            stride=2)
        self.stage2 = self._make_stage(channels_list[0], channels_list[1],
                                       num_repeats[1])
        self.stage3 = self._make_stage(channels_list[1], channels_list[2],
                                       num_repeats[2])
        self.stage4 = self._make_stage(channels_list[2], channels_list[3],
                                       num_repeats[3])
